...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setError("Arc Testnet temporarily unavailable");
        setIsLoading(false);
      }
    }
  ...
  // Governance Health Chart Data
  const healthData = [
    { name: 'Health', value: 85, fill: '#1D9E75' }
  ];
        ...
        <div className="flex-grow flex items-center justify-center p-4">
          <div className="text-center space-y-4">
            ...
            <button 
              ...
              className="px-6 py-2 bg-[#1D9E75] text-white rounded-xl font-bold"
            >
              Retry
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-[#0F1117] text-gray-900 dark:text-white">
      ...
      <div className="w-full border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/30 py-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between text-[11px] font-bold tracking-wider uppercase text-gray-500">
          {isLoading ? (
      ...
      <main className="flex-grow">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link href="/governance" className="px-8 py-4 bg-[#1D9E75] text-white font-black rounded-2xl hover:bg-[#0F6E56] transition-all active:scale-95 shadow-lg shadow-[#1D9E75]/20">
              VIEW PROPOSALS
            </Link>
            <Link href="/validators" className="px-8 py-4 border-2 border-gray-100 dark:border-gray-800 font-black rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all active:scale-95">
              MEET VALIDATORS
            </Link>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 mb-24">
          ...
          <div className="lg:col-span-1 bg-gray-50/50 dark:bg-gray-900/30 rounded-[32px] p-8 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-500 mb-6 max-w-[200px]">
              Calculated from validator uptime + quantum readiness
            </p>
